...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-6 mt-14 bg-gray-700 rounded-2xl shadow-lg max-w-xl mx-auto ">
            <h2 class="text-2xl font-bold text-white mb-6 text-center">Créer un compte utilisateur</h2>


            <form  Action="includes/treatment.php" method="POST" class="max-w-md mx-auto ">
                ...
                <p class="text-sm">
                    ...
                    <a href="connexion.php" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Se connecter</a>
                </p>
                </div>
            </form>
